...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom">  <h3><a href="../index.php">DINUS HOTEL HOMEPAGE</a></h3></div>
</body>
</html>
<?php
   include('db.php');
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      // username and password dikirim dari form 
      ...
      if($count == 1) {
         ...
         echo '<script>alert("Password atau Nama pengguna Salah!") </script>' ;
      }
   }
?>
