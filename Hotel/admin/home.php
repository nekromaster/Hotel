        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="messages.php"><i class="fa fa-desktop"></i>Kabar Berita</a>
                    </li>
					<li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>Booking Kamar </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Kamar dipesan  <span class="badge"><?php echo $r ; ?></span>
											</button>
                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            ...
                                            <h4 class='modal-title' id='myModalLabel'>Ganti Nama Pengguna atau Psswd</h4>
                                        </div>
										<form method='post>
                                        <div class='modal-body'>
                                            <div class='form-group'>
                                            <label>Ganti nama Pengguna</label>
