        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i> Berita</a>
                    </li>
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i>Pesanan Ruangan </a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
			 <div class="row">
			   ...
			   ?>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3>Kirim Berita ke pelanggan</h3>
						<?php
