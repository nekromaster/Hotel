        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="roombook.php"><i class="fa fa-bar-chart-o"></i>Kamar dipesan</a>
                    </li>
                    <li>
...
<?php
						...
						{	
							...
							if($st=="Conform")
							{
								...
								if($f1=="NO" )
								{
									echo "<script type='text/javascript'> alert('Maaf! Kamar Tipe Superior Tidak tersedia ')</script>";
								}
								else if($f2 =="NO")
									{
										echo "<script type='text/javascript'> alert('Maaf! Kamar Tipe GUEST Tidak tersedia ')</script>";
										
									}
									else if ($f3 == "NO")
									{
										echo "<script type='text/javascript'> alert(Maaf! Kamar Tipe SINGLE Tidak tersedia ')</script>";
									}
										else if($f4=="NO")
										{
										echo "<script type='text/javascript'> alert('Maaf! Kamar Tipe DELUXE Tidak tersedia ')</script>";
										}
